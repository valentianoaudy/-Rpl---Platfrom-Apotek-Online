            ...
            <div id="top">
                ...
                <div id="content">
                    <div id="container">
                        ...
                        <hr>
                        <h4 herf=""> Tambah Data Obat</h4>
                    </div>

                    <form action="./inputobat" method="post" enctype="multipart/form-data" >
                        <div class="formnarkotika">
                            ...
                            <tr>
                                <td>Stok</td>
                                <td>:</td>
                                <td><input type="text" name="qty"/></td><br>
                            </tr>
                            <label>Gambar Resep :</label>
                            <input class="form" required type="file" name="foto"><br>
                            <button type="submit" class="tombol">Tambah Data Obat</button>
                        </div>
                    </form>
                </div>
