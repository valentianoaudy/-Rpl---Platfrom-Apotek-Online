    ...
    <body>
        <%
            ...
            if (rs.next()) {
                ...
                response.sendRedirect("DashborAdmin.html");
            } else if (userid.equals("kepala") && pwd.equals("kepala12")) {
                response.sendRedirect("DashborKepala.html");
            } else {
                out.println("<h3><p>Password Salah!!!</p> <br> <a href='loginadmin&kepala.jsp'>Silahkan coba lagi???Click me!!</a><h3><hr>");
            }
        %>
    </body>
</html>
