...
<html>
    ...
    <body>
        <div id="home">
            <div id="top">
                <div class="header">
                    <h1>DASHBOARD Kepala Puskemas</h1>
                    <h3>Apotek Puskemas</h3>
                </div>
                <div class="kliklogout">
                    <ul>
                        <li><a href="loginadmin&kepala.jsp" class="logout">Kepala</a></li>
                </div>
                <div class="menu">
                    <ul>
                ...
                <div id="content">
                    ...
                    <center>
                        ...
                        <table border="2" class="tabel_admin">
                            <tr>
                                <th>ID</th><th>Nama</th><th>No</th><th>Alamat</th><th>No Hp</th><th>Nama File</th><th>Jalur</th><th>Tanggal</th><th>Download Gambar</th>
                            </tr>
                            <%
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="aksi">
                                        <a href="DownloadServlet?fileName=<%=rs.getString(6)%>">Download</a>
                                    </div>
                                </td>
